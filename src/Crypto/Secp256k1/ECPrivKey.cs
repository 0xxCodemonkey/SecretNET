...
internal interface INonceFunctionHardened
{
...
partial class ECPrivKey : IDisposable
{
    ...
    /// <exception cref="ArgumentException">If the tweak is not 32 bytes or if the tweak was out of range (chance of around 1 in 2^128 for uniformly random 32-byte arrays, or if the resulting private key would be invalid(only when the tweak is the complement of the private key)</exception>
    /// <exception cref="ObjectDisposedException">This instance has been disposed</exception>
