...
using SecretNET.Crypto.BouncyCastle;

namespace SecretNET.Common.Crypto;
	...
	: GeneralDigest
{
    ...
    /**
        ...
        * message digest.
        */
    internal RipeMD160Digest(RipeMD160Digest t) : base(t)
	{
		CopyIn(t);
	}
    ...
    internal override string AlgorithmName
	{
		get
		{
			return "RIPEMD160";
    ...
    internal override int GetDigestSize()
	{
		return DigestLength;
	}
