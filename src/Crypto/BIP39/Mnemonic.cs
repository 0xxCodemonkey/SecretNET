...
public class Mnemonic
{
	...
	/// <exception cref="System.ArgumentNullException">mnemonic</exception>
	/// <exception cref="System.FormatException">Word count should be 12,15,18,21 or 24</exception>
    ...
    internal ExtKey DeriveExtKey(string? passphrase = null)
    {
